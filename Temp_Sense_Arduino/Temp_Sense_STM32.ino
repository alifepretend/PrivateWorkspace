...
int read;
// 8 NTC, 1 Pt100
vector<int> ntc_pins = {A0, A1, A2, A3, A5, A6, A4, D6, D3};
...
void loop() {
  readNtcAll(ntc_pins, pin_values, d_time);

  delay(20);
}

static void readNtcAll(vector<int> pins, vector<int> values, long int d_time) {
...
#ifdef ATEMP
static int readTempSensor(int VRef)
{
